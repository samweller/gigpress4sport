...
function gigpress_prepare($show, $scope = 'public') {
	...
	//print_r($show);
	//echo '<p>xxxxxxxxxxxxxxxxxxxxxx</p>';
	...
	if($scope != 'venue') {
		...
		// xxxxxxxxxxxxx will out put the values xxxxxxxxxxxxxxx
		$showdata['opponent'] = wptexturize($show->opponent_name);
		$showdata['opponent_id'] = $show->show_opponent_id;
  ...
  echo '<p>ssssssssssssssss show data in gigpress.php ssssssssssssssssssss</p>';
	print_r($showdata);
